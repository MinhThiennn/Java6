...
<body>
			...
			<div class="container">
				<div class="cate-list">
					<div
						...
						style="cursor: grab;">
						<div class="swiper-wrapper" id="swiper-wrapper-200032b862f1f078"
							aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
							<div class="swiper-slide swiper-slide-active" role="group"
								aria-label="1 / 6" style="width: 188px; margin-right: 30px;">
								<div class="cate-item">
									<a class="image" href="thuc-an-danh-cho-cho"
										title="Thức ăn<br>dành cho chó"> <img
							...
							<div class="swiper-slide swiper-slide-next" role="group"
								aria-label="2 / 6" style="width: 188px; margin-right: 30px;">
								<div class="cate-item">
									<a class="image" href="thuc-an-danh-cho-meo"
										title="Thức ăn<br>dành cho mèo"> <img
										class="image_cate_thumb lazy loaded" width="241" height="220"
							...
							<div class="swiper-slide" role="group" aria-label="3 / 6"
								...
								<div class="cate-item">
									<a class="image" href="phu-kien-cho-thu-cung"
										title="Phụ kiện<br>cho thú cưng"> <img
										class="image_cate_thumb lazy loaded" width="241" height="220"
										src="../Asm-TaiNguyen/images/cate_3.webp" data-src=""
										alt="Phụ kiện<br>cho thú cưng" data-was-processed="true">
									</a>
									<h3 class="title_cate_">
										<a href="phu-kien-cho-thu-cung"
											title="Phụ kiện<br>cho thú cưng">Phụ kiện<br>cho thú
											cưng
										</a>
									</h3>
								</div>
							...
							<div class="swiper-slide" role="group" aria-label="4 / 6"
								style="width: 188px; margin-right: 30px;">
								<div class="cate-item">
									<a class="image" href="cham-soc-suc-khoe"
										title="Chăm sóc<br>sức khỏe"> <img
										class="image_cate_thumb lazy loaded" width="241" height="220"
							...
							<div class="swiper-slide" role="group" aria-label="5 / 6"
								style="width: 188px; margin-right: 30px;">
								<div class="cate-item">
									<a class="image" href="ve-sinh-cho-thu-cung"
										title="Vệ sinh<br>thú cưng"> <img
										class="image_cate_thumb lazy loaded" width="241" height="220"
							...
							<div class="swiper-slide" role="group" aria-label="6 / 6"
								...
								<div class="cate-item">
									<a class="image" href="4paws" title="On sale"> <img
										class="image_cate_thumb lazy loaded" width="241" height="220"
										src="../Asm-TaiNguyen/images/cate_6.webp" data-src=""
										alt="On sale" data-was-processed="true">
									</a>
									<h3 class="title_cate_">
	...
	<section class="awe-section-4">
		<div class="section_banner">
			<div class="container">
				<div
					class="banner-swiper swiper-container swiper-container-initialized swiper-container-horizontal"
					style="cursor: grab;">
					<div class="swiper-wrapper" id="swiper-wrapper-53b91a8a7ac62199"
						aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
						<div class="swiper-slide swiper-slide-active" role="group"
							aria-label="1 / 2" style="width: 630px; margin-right: 20px;">
							<a href="#" class="clearfix" title="Thức ăn cho chó"> <picture>
								<img width="630" height="280"
									src="../Asm-TaiNguyen/images/banner_1.webp"
									alt="Thức ăn cho chó" class="img-responsive center-block">
								</picture>
							</a>
						</div>
						<div class="swiper-slide swiper-slide-next" role="group"
							aria-label="2 / 2" style="width: 630px; margin-right: 20px;">
							<a href="#" class="clearfix" title="Thức ăn cho mèo"> <picture>
								<img width="630" height="280"
									src="../Asm-TaiNguyen/images/banner_2.webp"
